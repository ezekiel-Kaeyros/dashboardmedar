...
description <- readxl::read_excel(file_path)
#desc <- data$description

sotu_corpus <- quanteda::corpus(description$Description)
...
dtm = quanteda::dtm[slam::row_sums(dtm) > 0, ]
...
route <- paste(path_data,"/Topic_modelling1", sep="")
