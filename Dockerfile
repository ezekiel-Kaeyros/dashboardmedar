...
RUN R -e "install.packages(c('dplyr', 'htmlwidgets', 'jsonlite', 'keyring', 'tidyr', 'shiny.fluent', 'leaflet', 'leaflet.minicharts', 'magrittr', 'plotly', 'ggplot2', 'reactable', 'rhino', 'rjson', 'sf', 'shiny', 'shiny.router', 'shinyjs', 'shinymanager', 'shinythemes', 'tm', 'wordcloud2', 'wordcloud', 'lubridate', 'stringr', 'upstartr', 'mongolite', 'glue', 'janitor', 'Rmpfr'))"
